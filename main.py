...
start_text = "💠 **Y͟a͟s͟i͟r͟P͟e͟d͟i͟a͟ B͟o͟t͟ S͟t͟a͟t͟u͟s͟**\n" # default for start_message.
start_message = os.getenv('START_MESSAGE', start_text) # text before the status to show.
end_text = "ℹ️ Status Bot Otomatis Terupdate Setiap 1 Jam." # default for end_message.
...
async def edit_message(data):
    async with client:
        ...
        text += f"\n**📶 Terakhir Dicek:** {current_time} - Asia/Jakarta\n\n"
        text += end_message
